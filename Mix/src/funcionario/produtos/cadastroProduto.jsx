            ...
            <div className="modalContent-product">
                ...
                <form className='container-form' onSubmit={onSubmit}>
                    ...
                    <div className="formGroup-price">
                        ...
                        <input className='input-style' type="number" id="precoAtual" name="precoAtual" step="0.01" required />
                    </div>
                    <div className="formGroup-price">
                        <label htmlFor="precoPromocao">Preço Promoção:</label>
                        <input className='input-style' type="number" id="precoPromocao" name="precoPromocao" step="0.01" />
                    </div>
                    </div>
                    ...
                    <div className="formGroup-date">
                        ...
                        <input className='input-style' type="date" id="dataValidade" name="dataValidade" required />
                    </div>
